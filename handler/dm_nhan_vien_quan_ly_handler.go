...
type DanhSachNhanVienQuanLyHandler struct {
	Repo repository.DanhSachNhanVienQuanLyRepo
}

func (u *DanhSachNhanVienQuanLyHandler) Insert(c echo.Context) error {
	data := new(DM_NhanVienQuanLy)
...
func (u *DanhSachNhanVienQuanLyHandler) Update(c echo.Context) (err error) {
...
func (u *DanhSachNhanVienQuanLyHandler) Delete(c echo.Context) (err error) {
...
func (u *DanhSachNhanVienQuanLyHandler) GetById(c echo.Context) (err error) {
...
func (u *DanhSachNhanVienQuanLyHandler) GetAll(c echo.Context) (err error) {
