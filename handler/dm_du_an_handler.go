...
type DM_DuAnHandler struct {
	Repo repository.DM_DuAnRepo
}

func (u *DM_DuAnHandler) Insert(c echo.Context) error {
	data := new(DM_DuAn)
...
func (u *DM_DuAnHandler) Update(c echo.Context) (err error) {
...
func (u *DM_DuAnHandler) Delete(c echo.Context) (err error) {
...
func (u *DM_DuAnHandler) GetById(c echo.Context) (err error) {
...
func (u *DM_DuAnHandler) GetAll(c echo.Context) (err error) {
